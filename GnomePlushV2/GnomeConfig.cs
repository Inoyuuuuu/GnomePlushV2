...
namespace GnomePlushV2
{
    ...
    internal class GnomeConfig : SyncedConfig2<GnomeConfig>
    {
        ...
        [SyncedEntryField]
        internal SyncedEntry<int> TINY_GNOME_SIZE_SPAWN_CHANCE, DEFAULT_GNOME_SIZE_SPAWN_CHANCE, BIG_GNOME_SIZE_SPAWN_CHANCE;
        [SyncedEntryField]
        internal SyncedEntry<float> EXPERIMENTAL_SIZE_MULTIPLIER;

        private const int gnomeRarity_DV = 85;
        ...
        private const int tinySizeSpawnChance_DV = 15;
        private const int defaultSizeSpawnChance_DV = 65;
        private const int bigSizeSpawnChance_DV = 20;
        ...
        public GnomeConfig(ConfigFile cfg) : base(MyPluginInfo.PLUGIN_GUID)
        {
            ...
            DEFAULT_GNOME_SIZE_SPAWN_CHANCE = cfg.BindSyncedEntry("GnomeSize", "defaultSizeSpawnChance", defaultSizeSpawnChance_DV,
                new ConfigDescription("Rarity of default gnomes (relative to the values of the other gnome sizes). LOWER VALUE = RARER", new AcceptableValueRange<int>(0, 100)));
            BIG_GNOME_SIZE_SPAWN_CHANCE = cfg.BindSyncedEntry("GnomeSize", "bigSizeSpawnChance", bigSizeSpawnChance_DV,
                new ConfigDescription("Rarity of tiny gnomes (relative to the values of the other gnome sizes). LOWER VALUE = RARER", new AcceptableValueRange<int>(0, 100)));
